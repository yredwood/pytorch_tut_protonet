...
def parse_args():
    ...
    parser.add_argument('--datatype', dest='datatype', default='cifar10')
    ...
    parser.add_argument('--per_gpu_batch', dest='per_gpu_batch', default=64, type=int)
    parser.add_argument('--aug_mixup', dest='aug_mixup', default=1, type=int)
    parser.add_argument('--arch', dest='arch', default='wdres')
